...
pub struct DeploymentResponseAnyOf1 {
    #[serde(rename = "arn")]
    pub arn: String,
...
impl DeploymentResponseAnyOf1 {
    pub fn new(arn: String, created_at: String, min_protocol_version: i32, max_protocol_version: i32) -> DeploymentResponseAnyOf1 {
