...
pub struct DetailedDeploymentResponseAnyOf {
    #[serde(rename = "uri")]
    pub uri: String,
...
impl DetailedDeploymentResponseAnyOf {
    pub fn new(uri: String, protocol_type: models::ProtocolType, created_at: String, min_protocol_version: i32, max_protocol_version: i32) -> DetailedDeploymentResponseAnyOf {
