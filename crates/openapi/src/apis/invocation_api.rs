...
/// struct for typed errors of method [`terminate_invocation`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum TerminateInvocationError {
...
pub async fn terminate_invocation(configuration: &configuration::Configuration, invocation_id: &str, mode: Option<models::TerminationMode>) -> Result<(), Error<TerminateInvocationError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<TerminateInvocationError> = serde_json::from_str(&local_var_content).ok();
